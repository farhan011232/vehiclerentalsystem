<html>
	...
	<body>
		<div class="up" id="up">
			<div class="logo"><img src="images/logo.png" height="100%" width="9.7%" style="float:left;margin:-1.2% 0 0 6.5%;">
		...
		<div style="text-align:center;padding:1% 0 5% 0"><img src="images/logo.png" style="height:auto;" height="25%" width="25%"></div>
		<div>
		...
		<h1 style="font-size:2vw;color:#292929;margin:-1.3% 0 0 71%">&gt;</h1>
			...
			<br><br>
		<img class="image" src="images/journey.avif">
			...
			<table  style="width:82%;margin:auto;">
				<tr>
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Vehico offers to make it easy for clients to get the right car at
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Vehico is emerging car rental company in delhi/india . We have been known in industry 
				...
				<tr>
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Vehico is a very customer friendly company where customer service and
					...
					<td>
						...
						<h3 style="color:grey;font-size:0.9vw;margin-left:45px;text-align:left;">Vehico is providing One Way Drop Services From Delhi / NCR. We offer 
