<html>
	...
	<body>
		...
		<ol style="margin:3% 0 3% 3%;list-style-type: decimal;color: #808080;">
			...
			<li>The customer agrees and accept that the use of the services given by vehico is at the sole risk of the 
			...
			<li>By any chance, if your flight or train or bus misses Vehico will not be liable for that.</li>
		</ol>
		...
		User(s) and Vehico with respect to access to and use of the website and the Services offered by Vehico, 
