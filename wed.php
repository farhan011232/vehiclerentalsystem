<html>
	...
	<body>
		<header>
		<div class="up" id="up">
		<div class="logo"><img  src="images/logo.png" height="100%" width="10%%" style="float:left;margin:-1.2% 0 0 6.5%;">
				<img height="25%" width="1.6%" src="images/phone.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;+91-9695230548&emsp;</font>
				<img height="21%" width="1.9%" src="images/message.png" style="height:auto;"><font style="font-size:1.254vw;">&ensp;Info@vehico.in</font></div>
				<div class="logo1"><center><img  src="images/logo.png" height="50%" width="30%"></center>
					<div class="call"><img height="25%" width="2.5%" src="images/phone.png" style="height:auto;"><font>+91-9695230548&emsp;</font></div>
					<div class="mail"><img height="21%" width="2.5%" src="images/message.png" style="height:auto;"><font>&ensp;Info@vehico.in</font></div></div>
			<nav>
				<ul>
		...
		<div class="head">
			...
			<br>      
            <font>Vehico is emerging car rental company in Uttar Pradesh/india . We have been known in industry for our 100% customer satisfaction</font>
        </div>
        </header>
        <br> <br> <br>
        ...
        <p style="color:grey;font-size:95%;text-align:left;margin:2% 80px 0 50%;">
            Vehico is emerging <b>car rental company in Delhi/India.</b> We have been known in the industry for our 100% customer satisfaction.<br>
            We provide cars on rent for business promotions, corporate meetings, wedding, and movies, etc.
            we have a wide range of luxury and premium cars for you. We think for a special occasion we need the right car at right prices, vehico provides the best car accordingly the customer requirement.<br><br>
        </p>
        <p style="font-size:95%;text-align:left;margin:10% 0 10% 4%;">
		We assured you the best of our services. Further for more assistance please feel free to call us – 8127869377.<br>
		<b><font color="#00afe5">Wedding Car On Rent, Luxury Car Hire In Uttar Pradesh, Marriage Car Rental Service Uttar Pradesh, Doli Car Rental In Uttar Pradesh</font></b>
		</p>
		</div>
		<div class="ccr1">
        ...
        <p style="color:grey;font-size:90%px;text-align:left;margin-left:2%;">
            Vehico is emerging <b>car rental company in Uttar Pradesh/India.</b> We have been known in the industry for our 100% customer satisfaction.<br>
            We provide cars on rent for business promotions, corporate meetings, wedding, and movies, etc.
            we have a wide range of luxury and premium cars for you. We think for a special occasion we need the right car at right prices, vehico provides the best car accordingly the customer requirement.<br><br>
        </p>
		...
		<footer>
			...
			<table>
				...
				<tr bgcolor="#252525">
					<td class="widget">
						<p class="text">Vehico is one of the reputed Travel<br>
						Company in India.At vehico<br>
